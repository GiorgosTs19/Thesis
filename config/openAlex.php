...
return [
    ...
    'required_work_fields' => ['id','ids','open_access','title','publication_date','publication_year','referenced_works_count',
        'language','type','updated_date','created_date','cited_by_api_url','authorships','counts_by_year'],

    'required_work_update_fields' => ['id','open_access','title','referenced_works_count','updated_date','authorships','counts_by_year'],

    'required_author_fields' => ['id','ids','display_name','cited_by_count',
        'works_count','counts_by_year','works_api_url','updated_date','created_date'],

    'required_author_update_fields' => ['id','cited_by_count','works_count','counts_by_year','updated_date'],
];
