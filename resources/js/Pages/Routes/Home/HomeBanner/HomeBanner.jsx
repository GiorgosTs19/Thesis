...
const HomeBanner = ({
    ...
    const renderProductivityAuthors = (author, index) =>
        renderAuthorItem(author, index, { works: true, citations: false });
    const renderCitationsAuthors = (author, index) =>
        renderAuthorItem(author, index, { works: false, citations: true });
                    ...
                    <div className={styles.card}>
                        <div className={"m-auto"}>
                            ...
                            <div className={styles.text}>
                                Explore a vast collection of renowned authors.
                                Uncover insights, and statistical data for each
                                literary figure.
                            </div>
                            <button
                                className={clsx(
                ...
                <div className={clsx(styles.wrapperDiv, "order-3 xl:order-3")}>
                    <div className={styles.card}>
                        <div className={"m-auto"}>
                            ...
                            />
                            <div className={styles.text}>
                                Search through an extensive catalog of papers,
                                discover details about each piece, and explore
                ...
                <div className={styles.bannerInnerContainer}>
                    <div className={styles.bannerTextContainer}>
                        <p className={styles.bannerText}>
                            Advance your scholarly presence effortlessly with
                            our platform. Follow these streamlined steps to
                            create your account and showcase your work
                            seamlessly.
                        </p>
                    </div>
            ...
            <div className={styles.timelineWrapper}>
                <Card className={styles.timeLineCard}>
                    <div className={styles.timeLineCardInnerContainer}>
                        ...
                        <div className={styles.timelineText}>
                            Kickstart your journey by creating an account on our
                            platform.
                        </div>
                    </div>
                </Card>
                <Card className={styles.timeLineCard}>
                    <div className={styles.timeLineCardInnerContainer}>
                        ...
                        <div className={"flex w-full flex-col"}>
                            <div className={styles.timelineText}>
                                Tell us who you are by providing your unique
                                identifiers, along with some essential details.
                            </div>
                ...
                <Card className={styles.timeLineCard}>
                    <div className={styles.timeLineCardInnerContainer}>
                        ...
                        <div className={styles.timelineText}>
                            Once you have shared your info, leave the rest to
                            us. We will seamlessly fetch your works and build
                            your profile.
                        </div>
                    </div>
                </Card>
...
const styles = {
    wrapperDiv:
        "col-span-3 flex flex-col xl:flex-row text-center h-full min-h-96",
    ...
    propertiesWrapper:
        "flex flex-wrap gap-10 m-auto py-1 text-center flex px-4 rounded-3xl",
    propertyWrapper: "flex-grow flex text-center mx-auto",
    propertyValue:
        "text-black text-2xl lg:text-3xl xxl:text-5xl font-bold mx-auto",
    ...
    bannerTextContainer:
        "mb-3 mr-4 flex flex-col items-start md:mb-0 md:flex-row md:items-center",
    bannerButtonContainer: "flex flex-shrink-0 items-center",
    bannerText:
        "flex items-center text-xl 4xl:text-2xl font-normal text-background",
};
