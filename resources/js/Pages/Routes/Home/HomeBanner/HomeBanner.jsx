...
const HomeBanner = ({worksByType}) => {
    return <>
        ...
        <div className={'flex flex-col mt-6'}>
            ...
            <div className={styles.outerGrid}>
                <div className={styles.wrapperDiv}>
                    <div className={'mx-auto text-lg lg:text-3xl border border-gray-300 rounded-full py-4 px-6 mb-4'}>
                        1
                    </div>
                    <div className={styles.text}>
                        Kickstart your journey by creating an account on our platform. It is the first step to boosting
                        your
                        authorial presence.
                    </div>
